...
output "oidc_key_reader_role_arn" {
  description = "ARN of the oidc-key-reader IAM role — MC ESO service accounts assume this to read OIDC signing keys from Secrets Manager"
  value       = aws_iam_role.oidc_key_reader.arn
}
